...
//				new Object[] { libro.getTitulo(), libro.getAutor(), libro.getIsbn(), libro.getEjemplares() });
//
//		return libro;
//	}
//
...
//		this.jdbcTemplate.update(SQL, libro.getTitulo(), libro.getAutor(), libro.getIsbn(), libro.getCodigo(), libro.getEjemplares());
